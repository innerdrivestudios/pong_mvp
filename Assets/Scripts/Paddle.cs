 ...
 * - through the transform (in Update)
 * - through the physics engine (using a rigidbody in FixedUpdate)
 * - through animation
 * 
 ...
 * and update them in FixedUpdate.
 * 
 ...
 * physics or is also influenced by physics.
 * 
